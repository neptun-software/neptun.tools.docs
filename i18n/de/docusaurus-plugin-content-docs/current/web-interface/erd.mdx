...
import erdImage from './img/ERD-2024-12-09T18-48-00-180Z.png';
...
Wir verwenden Drizzle als ORM. Die Tabelle `\_\_drizzle_migrations` speichert unsere Migrationen.
...
```
  ...
  <TabItem value="png" label="PNG">
    <ZoomableImage src={erdImage} alt="ERD" />
  </TabItem>
